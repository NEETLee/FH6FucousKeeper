...
static const WCHAR *s_strings_zh[STR_COUNT] = {
    ...
    /* STR_PIPE_TITLE */        L"\u2500\u2500 \u81ea\u52a8\u5237\u8f66\u6d41\u6c34\u7ebf \u2500\u2500",
    /* STR_PIPE_CAR */          L"\u8f66\u8f86\uff1a",
    /* STR_PIPE_STEPS_LABEL */  L"\u5faa\u73af\u6b65\u9aa4\uff1a",
    /* STR_PIPE_STEP_RACE */    L"\u8d5b\u4e8b",
    /* STR_PIPE_STEP_BUY */     L"\u4e70\u8f66",
    /* STR_PIPE_STEP_SPIN */    L"\u62bd\u5956",
    /* STR_PIPE_STEP_REMOVE */  L"\u5220\u8f66",
    /* STR_PIPE_TARGET_SP */    L"\u76ee\u6807SP",
    /* STR_PIPE_SP_PER_LAP */   L"\u6bcf\u5708SP",
    /* STR_PIPE_CYCLES */       L"\u5faa\u73af\u8f6e\u6570",
    /* STR_PIPE_AUTO_COUNT */   L"\u81ea\u52a8\u7b97\u91cf",
    /* STR_PIPE_COST */         L"\u5355\u8f66CR",
    /* STR_PIPE_SP_PER_CAR */   L"\u5355\u8f66SP",
    /* STR_PIPE_MANUAL_COUNT */ L"\u624b\u52a8\u6570\u91cf",
    /* STR_PIPE_READ */         L"\u5237\u65b0CR/SP",
    /* STR_PIPE_BTN_LOOP */     L"\u5f00\u59cb\u5b8c\u6574\u5faa\u73af",
    /* STR_PIPE_BTN_STOP */     L"\u505c\u6b62 (F8)",
    /* STR_PIPE_SINGLE_LABEL */ L"\u5355\u6b65\u6267\u884c\uff1a",
    /* STR_PIPE_ECON_FMT */     L"CR: %s | SP: %s | \u53ef\u4e70: %s",
    /* STR_PIPE_STAGE_FMT */    L"\u9636\u6bb5: %s | %s",
    /* STR_PIPE_TOTALS_FMT */   L"\u7d2f\u8ba1 \u4e70:%d \u62bd:%d \u5220:%d \u8d5b:%d",
    /* STR_PIPE_STAGE_IDLE */   L"\u5c31\u7eea",
    /* STR_PIPE_STAGE_READ */   L"\u6b63\u5728\u8bfb\u53d6CR/SP",
    /* STR_PIPE_STAGE_BUY */    L"\u6b63\u5728\u8d2d\u4e70",
    /* STR_PIPE_STAGE_SPIN */   L"\u6b63\u5728\u62bd\u5956",
    /* STR_PIPE_STAGE_REMOVE */ L"\u6b63\u5728\u5220\u9664\u8f66\u8f86",
    /* STR_PIPE_STAGE_RACE */   L"\u6b63\u5728\u8dd1\u56fe",
    /* STR_PIPE_STAGE_STEP_DONE */ L"\u6b65\u9aa4\u5b8c\u6210",
    /* STR_PIPE_STAGE_ALL_DONE */  L"\u5168\u90e8\u5b8c\u6210",
    /* STR_PIPE_STAGE_INIT_FAIL */ L"\u521d\u59cb\u5316\u5931\u8d25",
    /* STR_PIPE_STAGE_RUNNING */   L"\u8fd0\u884c\u4e2d",
    /* STR_PIPE_STATUS_ERROR */    L"\u9519\u8bef",
    /* STR_PIPE_ERR_NO_GAME */  L"\u672a\u627e\u5230\u6e38\u620f\u7a97\u53e3\u6216\u622a\u5c4f\u521d\u59cb\u5316\u5931\u8d25\u3002\u8bf7\u5148\u5728\u72b6\u6001\u9875\u70b9\u201c\u67e5\u627e\u6e38\u620f\u201d\u3002",
    ...
    /* STR_PIPE_FH6_ONLY */     L"\u4ec5\u9009\u4e2d FH6 \u7a97\u53e3\u65f6\u53ef\u4f7f\u7528\u81ea\u52a8\u8d5b\u4e8b",
...
static const WCHAR *s_strings_en[STR_COUNT] = {
    ...
    /* STR_PIPE_TITLE */        L"\u2500\u2500 Auto Farm Pipeline \u2500\u2500",
    /* STR_PIPE_CAR */          L"Car:",
    /* STR_PIPE_STEPS_LABEL */  L"Loop steps:",
    /* STR_PIPE_STEP_RACE */    L"Race",
    /* STR_PIPE_STEP_BUY */     L"Buy",
    /* STR_PIPE_STEP_SPIN */    L"Spin",
    /* STR_PIPE_STEP_REMOVE */  L"Remove",
    /* STR_PIPE_TARGET_SP */    L"Target SP",
    /* STR_PIPE_SP_PER_LAP */   L"SP/Lap",
    /* STR_PIPE_CYCLES */       L"Cycles",
    /* STR_PIPE_AUTO_COUNT */   L"Auto Qty",
    /* STR_PIPE_COST */         L"CR/Car",
    /* STR_PIPE_SP_PER_CAR */   L"SP/Car",
    /* STR_PIPE_MANUAL_COUNT */ L"Count",
    /* STR_PIPE_READ */         L"Refresh CR/SP",
    /* STR_PIPE_BTN_LOOP */     L"Start Full Loop",
    /* STR_PIPE_BTN_STOP */     L"Stop (F8)",
    /* STR_PIPE_SINGLE_LABEL */ L"Single step:",
    /* STR_PIPE_ECON_FMT */     L"CR: %s | SP: %s | Buyable: %s",
    /* STR_PIPE_STAGE_FMT */    L"Stage: %s | %s",
    /* STR_PIPE_TOTALS_FMT */   L"Total Buy:%d Spin:%d Del:%d Race:%d",
    /* STR_PIPE_STAGE_IDLE */   L"Ready",
    /* STR_PIPE_STAGE_READ */   L"Reading CR/SP",
    /* STR_PIPE_STAGE_BUY */    L"Buying",
    /* STR_PIPE_STAGE_SPIN */   L"Wheelspinning",
    /* STR_PIPE_STAGE_REMOVE */ L"Removing cars",
    /* STR_PIPE_STAGE_RACE */   L"Racing",
    /* STR_PIPE_STAGE_STEP_DONE */ L"Step done",
    /* STR_PIPE_STAGE_ALL_DONE */  L"All done",
    /* STR_PIPE_STAGE_INIT_FAIL */ L"Init failed",
    /* STR_PIPE_STAGE_RUNNING */   L"Running",
    /* STR_PIPE_STATUS_ERROR */    L"Error",
    /* STR_PIPE_ERR_NO_GAME */  L"Game window not found or capture init failed. Click \"Find Game\" on the Status tab first.",
    ...
    /* STR_PIPE_FH6_ONLY */     L"Automation is available only for a selected FH6 window",
...
static const WCHAR *s_strings_zh_tw[STR_COUNT] = {
    ...
    /* STR_PIPE_TITLE */        L"\u2500\u2500 \u81ea\u52d5\u5237\u8eca\u6d41\u6c34\u7dda \u2500\u2500",
    /* STR_PIPE_CAR */          L"\u8eca\u8f1b\uff1a",
    /* STR_PIPE_STEPS_LABEL */  L"\u5faa\u74b0\u6b65\u9a5f\uff1a",
    /* STR_PIPE_STEP_RACE */    L"\u8cfd\u4e8b",
    /* STR_PIPE_STEP_BUY */     L"\u8cb7\u8eca",
    /* STR_PIPE_STEP_SPIN */    L"\u62bd\u734e",
    /* STR_PIPE_STEP_REMOVE */  L"\u522a\u8eca",
    /* STR_PIPE_TARGET_SP */    L"\u76ee\u6a19SP",
    /* STR_PIPE_SP_PER_LAP */   L"\u6bcf\u5708SP",
    /* STR_PIPE_CYCLES */       L"\u5faa\u74b0\u8f2a\u6578",
    /* STR_PIPE_AUTO_COUNT */   L"\u81ea\u52d5\u7b97\u91cf",
    /* STR_PIPE_COST */         L"\u55ae\u8ecaCR",
    /* STR_PIPE_SP_PER_CAR */   L"\u55ae\u8ecaSP",
    /* STR_PIPE_MANUAL_COUNT */ L"\u624b\u52d5\u6578\u91cf",
    /* STR_PIPE_READ */         L"\u5237\u65b0CR/SP",
    /* STR_PIPE_BTN_LOOP */     L"\u958b\u59cb\u5b8c\u6574\u5faa\u74b0",
    /* STR_PIPE_BTN_STOP */     L"\u505c\u6b62 (F8)",
    /* STR_PIPE_SINGLE_LABEL */ L"\u55ae\u6b65\u57f7\u884c\uff1a",
    /* STR_PIPE_ECON_FMT */     L"CR: %s | SP: %s | \u53ef\u8cb7: %s",
    /* STR_PIPE_STAGE_FMT */    L"\u968e\u6bb5: %s | %s",
    /* STR_PIPE_TOTALS_FMT */   L"\u7d2f\u8a08 \u8cb7:%d \u62bd:%d \u522a:%d \u8cfd:%d",
    /* STR_PIPE_STAGE_IDLE */   L"\u5c31\u7dd2",
    /* STR_PIPE_STAGE_READ */   L"\u6b63\u5728\u8b80\u53d6CR/SP",
    /* STR_PIPE_STAGE_BUY */    L"\u6b63\u5728\u8cfc\u8cb7",
    /* STR_PIPE_STAGE_SPIN */   L"\u6b63\u5728\u62bd\u734e",
    /* STR_PIPE_STAGE_REMOVE */ L"\u6b63\u5728\u522a\u9664\u8eca\u8f1b",
    /* STR_PIPE_STAGE_RACE */   L"\u6b63\u5728\u8dd1\u5716",
    /* STR_PIPE_STAGE_STEP_DONE */ L"\u6b65\u9a5f\u5b8c\u6210",
    /* STR_PIPE_STAGE_ALL_DONE */  L"\u5168\u90e8\u5b8c\u6210",
    /* STR_PIPE_STAGE_INIT_FAIL */ L"\u521d\u59cb\u5316\u5931\u6557",
    /* STR_PIPE_STAGE_RUNNING */   L"\u57f7\u884c\u4e2d",
    /* STR_PIPE_STATUS_ERROR */    L"\u932f\u8aa4",
    /* STR_PIPE_ERR_NO_GAME */  L"\u672a\u627e\u5230\u904a\u6232\u8996\u7a97\u6216\u622a\u5716\u521d\u59cb\u5316\u5931\u6557\u3002\u8acb\u5148\u5728\u72c0\u614b\u9801\u9ede\u201c\u5c0b\u627e\u904a\u6232\u201d\u3002",
    ...
    /* STR_PIPE_FH6_ONLY */     L"\u50c5\u9078\u4e2d FH6 \u8996\u7a97\u6642\u53ef\u4f7f\u7528\u81ea\u52d5\u8cfd\u4e8b",
